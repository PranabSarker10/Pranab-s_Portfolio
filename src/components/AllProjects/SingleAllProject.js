        ...
        <div class="col">
            <div class="card h-100 shadow-sm project">
                ...
                <div className="card-footer pb-4 bg-white border-top-0 ">
                    ...
                    <a href={p.live} target="_blank" rel="noreferrer" className="btn btn-sm btn-outline-dark me-2 mb-2 mb-md-0" type="button">
...

                    {
                        ...
                        <a href={p.server} target="_blank" rel="noreferrer" className="">
                            <button className="btn btn-sm btn-outline-dark me-2 mt-2">
